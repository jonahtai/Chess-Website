...
async function getLeaderboard() {
    ...
    try {
        const response = await fetch(`https://checkchesser.com/api/leaderboard?schools=${encodeURIComponent(schools)}&minRating=${encodeURIComponent(minimumRating)}&maxRating=${encodeURIComponent(maximumRating)}`);
        if (response.ok) {
